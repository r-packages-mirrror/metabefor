...
date: "2022-01-05 at 17:09:03 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-x1WqhG, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-vBOaVy}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-FH1B2I, results='asis'}
...
```{r rxs-setup-chunk-x1WqhG, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-aVYdBi, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  "association", "association", "association", "association"), 
      ...
      valueTemplateCols = list(identifierCol = "identifier", descriptionCol = "description", 
          ...
          title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-05 at 17:09:03 CET (UTC+0100)"), 
