```{r rxs-setup-chunk-yDxM0v, echo=FALSE, results='hide'}
```
  ...
  ############################################################################
    ...
    ##########################################################################
      ...
      ########################################################################
          ...
          list(variableIdentifier = "varId",  ### Variable Identifier: The unique identifier for this variable [Examples: "example1"; "another_identifier_example"; "finalExample"] [Value description: A single character value that is used as an identifier and so is always mandatory and can only contain a-z, A-Z, 0-9, and underscores, and must start with a letter.]
  ...
  ############################################################################
    ...
    ##########################################################################
      ...
      ########################################################################
          ...
          list(associationIdentifier = "associationId",           ### Association Identifier: A unique identifier for this association [Examples: "example1"; "another_identifier_example"; "finalExample"] [Value description: A single character value that is used as an identifier and so is always mandatory and can only contain a-z, A-Z, 0-9, and underscores, and must start with a letter.]
...
```{r rxs-show-extracted-data-chunk-SqyuQ8}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-vbtwjl, results='asis'}
...
```{r rxs-setup-chunk-yDxM0v, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-S2zaxN, echo=FALSE}
