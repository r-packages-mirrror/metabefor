...
date: "2022-01-06 at 13:42:49 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-JWODiS, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-tN4KOj}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-m1qUwF, results='asis'}
...
```{r rxs-setup-chunk-JWODiS, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-Ghzds0, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      valueTemplateCols = list(identifierCol = "identifier", descriptionCol = "description", 
          ...
          title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-06 at 13:42:49 CET (UTC+0100)"), 
