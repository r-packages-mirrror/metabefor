...
date: "2022-01-07 at 22:39:21 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-BASdXk, echo=FALSE, results='hide'}
```
...
### https://shortdoi.org (the part after the "10/"). For sources without a
...
### screening phase or which you can create with `metabefor::qurid()`.
### 
### EXAMPLES:
### 
### "g5fj"
...
```{r rxs-show-extracted-data-chunk-nx8ysN}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-uMstP5, results='asis'}
...
```{r rxs-setup-chunk-BASdXk, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-U8kjc4, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      yamlMetadata = list(title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-07 at 22:39:21 CET (UTC+0100)"), 
