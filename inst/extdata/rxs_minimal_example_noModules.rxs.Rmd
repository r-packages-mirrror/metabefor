...
date: "2022-01-08 at 09:51:47 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-FreLG5, echo=FALSE, results='hide'}
```
    ...
    ##########################################################################
      ...
      ########################################################################
          ...
          list(variableIdentifier = NA,  ### Variable Identifier: The unique identifier for this variable [Examples: "example1"; "another_identifier_example"; "finalExample"] [Value description: A single character value that is used as an identifier and so is always mandatory and can only contain a-z, A-Z, 0-9, and underscores, and must start with a letter.]
               measurementLevel = NA);   ### Measurement Level: The emasurement level of this variable [Examples: c("Nominal", "Ordinal", "Continuous")] [Value description: A string that has to exactly match one of the values specified in the "values" column of the Coding sheet]
...
```{r rxs-show-extracted-data-chunk-um5EcV}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-PbBGxc, results='asis'}
...
```{r rxs-setup-chunk-FreLG5, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-UHo4YZ, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  "Measurement Level", "Associations", "Association", "Association Identifier", 
  "Variable Identifier vor variable 1", "Variable Identifier vor variable 2", 
  ...
  "The emasurement level of this variable", "Associations that are extracted from this study", 
  ...
  "measurementLevel", "associations", "association", "associationIdentifier", 
  "varId1", "varId2", "r", "t"), valueTemplate = c(NA, "integer.length4.multi", 
  "string.mandatory", "string.mandatory", NA, NA, "integer", "string", 
  "categorical", NA, NA, NA, "string.identifier", "categorical", 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      "methods", NA, "methods", "variables", "variable", "variable", 
      NA, "associations", "association", "association", "association", 
      "association", "association"), module = c("module1", "module1", 
      "module1", "module1", "module2", "module2", "module2", "module2", 
      "module2", "module3", "module3", "module3", "module3", "module3", 
      ...
      NA, NA, NA, NA, NA, NA, "TRUE", NA, NA, NA, "TRUE", NA, NA, 
      ...
      NA, NA, NA, NA, NA, NA, NA, NA, NA, "TRUE", NA, NA, NA, "TRUE", 
      ...
      yamlMetadata = list(title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-08 at 09:51:47 CET (UTC+0100)"))
