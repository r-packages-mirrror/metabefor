...
date: "2022-01-06 at 10:49:56 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-UJ02wH, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-HFMQpn}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-736ILl, results='asis'}
...
```{r rxs-setup-chunk-UJ02wH, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-QKFcJ0, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  "association", "association", "association", "association"), 
      ...
      valueTemplateCols = list(identifierCol = "identifier", descriptionCol = "description", 
          ...
          title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-06 at 10:49:56 CET (UTC+0100)"), 
