...
date: "2022-01-07 at 11:01:36 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-HzDncQ, echo=FALSE, results='hide'}
```
...
################################################################################
  ...
  ##############################################################################
    ...
    ############################################################################
      ...
      ##########################################################################
          ...
          list(variableIdentifier = "bla",  ### Variable Identifier: The unique identifier for this variable [Examples: "example1"; "another_identifier_example"; "finalExample"] [Value description: A single character value that is used as an identifier and so is always mandatory and can only contain a-z, A-Z, 0-9, and underscores, and must start with a letter.]
               measurementLevel = NA);   ### Results: The results from this study. [Examples: c("Nominal", "Ordinal", "Continuous")] [Value description: A string that has to exactly match one of the values specified in the "values" column of the Coding sheet]
  ...
  ##############################################################################
    ...
    ############################################################################
        ...
        list(associationIdentifier = "bla",           ### Association Identifier: A unique identifier for this association [Examples: "example1"; "another_identifier_example"; "finalExample"] [Value description: A single character value that is used as an identifier and so is always mandatory and can only contain a-z, A-Z, 0-9, and underscores, and must start with a letter.]
...
if (!(grepl("^[a-zA-Z][a-zA-Z0-9_]*$", rxsObject$rxsMetadata$extractorId, ignore.case=TRUE))) {
  stop("The extractor identifier you specified, '", rxsObject$rxsMetadata$extractorId, 
       "', does not validate (i.e., it does not match the predefined format)!");
}
```


```{r rxs-show-extracted-data-chunk-KW2RSl}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-pAnoKh, results='asis'}
...
```{r rxs-setup-chunk-HzDncQ, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-WvmZCp, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      valueTemplateCols = list(identifierCol = "identifier", descriptionCol = "description", 
          ...
          title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-07 at 11:01:36 CET (UTC+0100)"), 
