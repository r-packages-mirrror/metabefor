```{r rxs-setup-chunk-YHQwe2, echo=FALSE, results='hide'}
```
...
```{r rxs-template-specification-chunk-DMLEmj, echo=FALSE, results='hide'}
```

```{r rxs-validation-chunk-psIXO1, results='asis'}
...
```{r rxs-show-extracted-data-chunk-bPkJNg}
if ((!(exists('parsingMultipleRxsFiles'))) || (!parsingMultipleRxsFiles)) {  metabefor::rxs_partial(rxsObject); }
```

```{r rxs-setup-chunk-YHQwe2, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-DMLEmj, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      "\"enter <<entityRef>> here\"", "NA", "NA", "NA", "NA"), 
          ...
          "NAME is not a single character value (i.e. a 'string'), but has value: VALUE", "Error about NAME here.", "Error about NAME here.", 
      ...
      -1L), class = "data.frame"), instructionSheet = structure(list(
          ...
          )), row.names = c(NA, -7L), class = "data.frame"), errorOnFailingValidation = FALSE, 
