...
```{r rxs-setup-chunk-FfXZ4w, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-tWPBSm}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-PS1lXt, results='asis'}
...
```{r rxs-setup-chunk-FfXZ4w, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-tuHUTN, echo=FALSE}
