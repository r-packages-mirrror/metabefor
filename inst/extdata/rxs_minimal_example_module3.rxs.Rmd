...
```{r rxs-setup-chunk-ptcDEV, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-vQHWMR}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-paCWdA, results='asis'}
...
```{r rxs-setup-chunk-ptcDEV, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-bdV2Mh, echo=FALSE}
