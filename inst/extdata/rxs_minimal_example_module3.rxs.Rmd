...
```{r rxs-setup-chunk-uWKBe6, echo=FALSE, results='hide'}
```
...
rxsObject$rxsMetadata <- list(rxsVersion='0.3.0', moduleId="module3", id=uniqueSourceIdentifier, extractorId=extractorIdentifier);
...
```{r rxs-show-extracted-data-chunk-AivZHu}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-wYFsNI, results='asis'}
...
```{r rxs-setup-chunk-uWKBe6, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-0hUoXk, echo=FALSE}
