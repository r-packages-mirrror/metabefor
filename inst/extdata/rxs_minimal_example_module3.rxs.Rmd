...
```{r rxs-setup-chunk-ahfxpQ, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-fy685m}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-zbC5dO, results='asis'}
...
```{r rxs-setup-chunk-ahfxpQ, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-EPQ5R3, echo=FALSE}
