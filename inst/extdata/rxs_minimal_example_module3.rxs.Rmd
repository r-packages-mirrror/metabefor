...
```{r rxs-setup-chunk-bsagMp, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-PNpfcy}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-D32YWw, results='asis'}
...
```{r rxs-setup-chunk-bsagMp, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-ISFihe, echo=FALSE}
