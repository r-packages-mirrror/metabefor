...
```{r rxs-setup-chunk-gVDbH1, echo=FALSE, results='hide'}
```
...
rxsObject$rxsMetadata <- list(rxsVersion='0.3.0', moduleId="module1", id=uniqueSourceIdentifier, extractorId=extractorIdentifier);
...
```{r rxs-show-extracted-data-chunk-S46gJG}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-pvYlLV, results='asis'}
...
```{r rxs-setup-chunk-gVDbH1, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-PYLugx, echo=FALSE}
