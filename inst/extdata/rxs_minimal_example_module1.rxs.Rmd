...
```{r rxs-setup-chunk-9UceIl, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-1oEfjb}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-9pBauK, results='asis'}
...
```{r rxs-setup-chunk-9UceIl, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-iV4Keg, echo=FALSE}
