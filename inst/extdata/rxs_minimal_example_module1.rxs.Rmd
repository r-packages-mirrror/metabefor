```{r rxs-setup-chunk-KE23w8, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-t56CaL}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-3udpRi, results='asis'}
...
```{r rxs-setup-chunk-KE23w8, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-ZCIvHp, echo=FALSE}
