...
```{r rxs-setup-chunk-bCBmce, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-qBDNg9}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-OQksZy, results='asis'}
...
```{r rxs-setup-chunk-bCBmce, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-fOY2AH, echo=FALSE}
