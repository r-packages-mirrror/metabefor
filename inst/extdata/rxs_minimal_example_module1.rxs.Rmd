...
```{r rxs-setup-chunk-A3rmCO, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-vC2Q7X}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-2EJykI, results='asis'}
...
```{r rxs-setup-chunk-A3rmCO, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-nECURS, echo=FALSE}
