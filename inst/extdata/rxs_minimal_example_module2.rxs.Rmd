...
date: "2022-01-06 at 10:49:57 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-sHLNxa, echo=FALSE, results='hide'}
```
...
################################################################################
  ...
  ##############################################################################
    ...
    ############################################################################
      ...
      ###################################################### START: variable ###
      ##########################################################################
      currentEntity <- currentEntity$AddChild('variable');
      currentEntity[['value']] <-
      ##########################################################################
      ### 
      ### VARIABLE
...
```{r rxs-show-extracted-data-chunk-iv7FGy}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-LAvENR, results='asis'}
...
```{r rxs-setup-chunk-sHLNxa, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-eb8Xh6, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  "association", "association", "association", "association"), 
      ...
      valueTemplateCols = list(identifierCol = "identifier", descriptionCol = "description", 
          ...
          title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-06 at 10:49:57 CET (UTC+0100)"), 
