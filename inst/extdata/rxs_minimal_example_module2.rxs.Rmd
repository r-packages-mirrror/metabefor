...
```{r rxs-setup-chunk-o3Ljxh, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-Akvqh0}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-h4PeA5, results='asis'}
...
```{r rxs-setup-chunk-o3Ljxh, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-AGu8sx, echo=FALSE}
