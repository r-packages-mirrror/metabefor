...
date: "2022-01-06 at 13:42:50 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-XHu60O, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-35eaIp}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-VCHeGz, results='asis'}
...
```{r rxs-setup-chunk-XHu60O, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-kC85ux, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      valueTemplateCols = list(identifierCol = "identifier", descriptionCol = "description", 
          ...
          title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-06 at 13:42:50 CET (UTC+0100)"), 
