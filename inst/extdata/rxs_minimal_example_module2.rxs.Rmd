```{r rxs-setup-chunk-0oaIqK, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-jyGM15}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-9xrcTg, results='asis'}
...
```{r rxs-setup-chunk-0oaIqK, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-9hA4Ja, echo=FALSE}
