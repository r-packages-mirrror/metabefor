...
date: "2022-01-07 at 11:01:37 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-wq0Hsi, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-IjBt9O}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-vJEqx7, results='asis'}
...
```{r rxs-setup-chunk-wq0Hsi, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-246rAh, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      valueTemplateCols = list(identifierCol = "identifier", descriptionCol = "description", 
          ...
          title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-07 at 11:01:37 CET (UTC+0100)"), 
