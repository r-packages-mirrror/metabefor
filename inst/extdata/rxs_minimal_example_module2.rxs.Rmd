...
date: "2022-01-08 at 09:51:49 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-vDFewf, echo=FALSE, results='hide'}
```
...
```{r rxs-show-extracted-data-chunk-KgYiCm}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-R7af6h, results='asis'}
...
```{r rxs-setup-chunk-vDFewf, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-2MUPHS, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      yamlMetadata = list(title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-08 at 09:51:49 CET (UTC+0100)"))
