...
date: "2022-01-07 at 22:39:23 CET (UTC+0100)"
output:
  html_document:
    self-contained: yes
    toc: false
...
```{r rxs-setup-chunk-Prey6U, echo=FALSE, results='hide'}
```
...
rxsObject$rxsMetadata <- list(rxsVersion='0.3.0', moduleId="module2", id=uniqueSourceIdentifier, extractorId=extractorIdentifier);
...
```{r rxs-show-extracted-data-chunk-bOmsY7}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-TfVm0q, results='asis'}
...
```{r rxs-setup-chunk-Prey6U, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-Di48uI, echo=FALSE}
...
rxsTemplateSpec <- 
  ...
  NA_character_, NA_character_, NA_character_, NA_character_), 
      ...
      yamlMetadata = list(title = "Systematic Review Extraction Script Template", 
          author = NULL, date = "2022-01-07 at 22:39:23 CET (UTC+0100)"), 
