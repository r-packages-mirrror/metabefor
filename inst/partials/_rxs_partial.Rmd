...
```{r, echo=echoPartial, results='asis', eval=(!is.null(studyTree$output$plot)), fig.width=5, fig.height=5, fig.cap="Scatterplot with regression line" }
  
  ufs::heading("Plot",
               headingLevel = headingLevel+1);
  
  studyTree$output$plot;
