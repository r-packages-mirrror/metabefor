...
```{r rxs-setup-chunk-VAY9Di, echo=FALSE, results='hide'}
```
...
################################################################################
  ...
  ##############################################################################
    ...
    ########################################################## START: method ###
    ############################################################################
    currentEntity <- currentEntity$AddChild('instruments');
    currentEntity[['value']] <-
    ############################################################################
    ### 
    ### METHOD
    ...
    ### 
    ############################################################################
    currentEntity[['validation']] <- expression(is.na(VALUE) || (VALUE %in% c("Qualitative", "Quantitative", "Mixed", "Review")));
    ...
    ############################################################################
      ...
      ##########################################################################
          ...
          list(variableIdentifier = "crayons",  ### Variable Identifier: The unique identifier for this variable [Examples: "example1"; "another_identifier_example"; "finalExample"] [Value description: A single character value that is used as an identifier and so is always mandatory and can only contain a-z, A-Z, 0-9, and underscores, and must start with a letter.]
               measurementLevel = "Nominal");   ### Results: The results from this study. [Examples: c("Nominal", "Ordinal", "Continuous")] [Value description: A string that has to exactly match one of the values specified in the "values" column of the Coding sheet]
      ...
      currentEntity$name <- currentEntity$value[['variableIdentifier']];
      currentEntity <- currentEntity$parent;
      ##########################################################################
  ...
  ##############################################################################
    ...
    ############################################################################
        ...
        list(associationIdentifier = "chalk_and_witches",           ### Association Identifier: A unique identifier for this association [Examples: "example1"; "another_identifier_example"; "finalExample"] [Value description: A single character value that is used as an identifier and so is always mandatory and can only contain a-z, A-Z, 0-9, and underscores, and must start with a letter.]
             varId1 = "chalk",  ### Variable Identifier vor variable 1: The identifier of the one variable (specified in the methods section) that this association relates to [Examples: <no example>] [Value description: A string that specifies another entity and which MUST be provided]
             varId2 = "witches",  ### Variable Identifier vor variable 2: The identifier of the other variable (specified in the methods section) that this association relates to [Examples: <no example>] [Value description: A string that specifies another entity and which MUST be provided]
             r = .8,                               ### Pearson's r: The Pearson correlation coefficient for this association (if both variables are continuous) [Examples: 2.3; 643.2] [Value description: Any valid number]
    ...
    currentEntity$name <- currentEntity$value[['associationIdentifier']];
...
```{r rxs-show-extracted-data-chunk-DmaKGo}
metabefor::rxs_partial(rxsObject);
```

```{r rxs-validation-chunk-XNG6bV, results='asis'}
...
```{r rxs-setup-chunk-VAY9Di, include=FALSE, messages=FALSE}
...
```{r rxs-template-specification-chunk-dwyOLT, echo=FALSE}
