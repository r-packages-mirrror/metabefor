...
This vignette contains definitions of the terms in `metabefor`. For more background information, check the documentation linked to in the Getting Started section of the [`metabefor` PkgDown site](https://r-packages.gitlab.io/metabefor).
